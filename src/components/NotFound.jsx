  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: colors.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', px: 2 }}>
      <Container maxWidth="sm" sx={{ textAlign: 'center' }}>
        ...
        <Button onClick={() => navigate('/')} startIcon={<ArrowBackRoundedIcon />} sx={{ px: 4, py: 1.4, borderRadius: '50px', background: gradients.primary, color: '#fff', fontWeight: 700, '&:hover': { background: gradients.primaryReversed } }}>Back to Home</Button>
      </Container>
    </Box>
  )
}